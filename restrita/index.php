...
<body>
    ...
    <?php
        ...
        foreach ($conex -> query($consulta) as $linha){
            ...
            <td>
                <a href="form_atualiza_aluno.php?ra=<?php echo $linha['ra']; ?>" class="btn btn-primary">Update</a>
                &nbsp; &nbsp; 
                <a href="delete_aluno.php?ra=<?php echo $linha['ra']; ?>" class="btn btn-danger">Update</a>
            </td>
